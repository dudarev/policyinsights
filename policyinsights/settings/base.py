"""
Django settings for policyinsights project.
...
SECRET_KEY = 'f1t^op@)pdwpzjaoi$^o5^5^$bpui$d$6pskaqyo86!hd+4zao'
...
ROOT_URLCONF = 'policyinsights.urls'
...
WSGI_APPLICATION = 'policyinsights.wsgi.application'
